...
while True: # Bucle while para preguntar si quiere hacer otro cálculo. 
    ...
    if edad < 18:
        print ("Por lo tanto eres menor de edad y el resultado del cálculo de IMC no es fiable.")
    else:
    ...
    # (complemento del while True del principio) Preguntar al usuario si quiere hacer otro cálculo
    repetir = input ("Quieres hacer otro cálculo de IMC? (si / no): ")
    if repetir.lower() != "si":
        break # termina el programa si la respuesta es diferente a "si"
